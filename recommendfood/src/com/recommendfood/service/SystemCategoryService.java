...
public class SystemCategoryService {
	private final String tableName = "SystemCategory";
	private SystemCategoryDaoIml dao;

	public SystemCategoryDaoIml getDao() {
		return dao;
	}

	public void setDao(SystemCategoryDaoIml dao) {
		this.dao = dao;
	}
...
//	}
	//添加
	public void save(SystemCategory b){
		this.dao.add(b);
	}
	//减少
	public void remove(SystemCategory b){
		this.dao.delete(b);
	}
	//更改
	public void update(SystemCategory b){
		this.dao.update(b);
	}
	//查询
	...
	//根据条件查询并排序
//	public List<SystemCategory> findBookListByParamsWithOrder(List<SearchObject> params, Map<String, String> orderColumns){
//		String[] paramNames = ParamUtil.getParamNames2(tableName, params);
//		Object[] values = ParamUtil.getParamValues2(params);
//		String sql = SqlUtil.createHqlWithNamedParamByParams2(tableName, params);
...
//	}
	//根据条件排序查询并分页
//	public List<SystemCategory> findBookListByParamsWithOrderAndPage(List<SearchObject> params, Map<String, String> orderColumns, int firstResult, int maxResult){
//		String[] paramNames = ParamUtil.getParamNames2(tableName, params);
//		Object[] values = ParamUtil.getParamValues2(params);
//		String sql = SqlUtil.createHqlWithNamedParamByParams2(tableName, params);
//		sql = SqlUtil.appendOrderToSql(tableName,sql, orderColumns);
